...
def MakeIndustrial(time_of_day='day',mybartender='bases/bartender_default.py'):
    ...
    Base.Link (room3, 'my_link_id', -1, -1, 1.99805, 0.0416667, 'Trade_Cargo', room3)
    Base.Link (room3, 'my_link_id', -1, -0.994792, 1.99609, 0.127604, 'Trade_Cargo', room2)
    Base.Link (room3, 'my_link_id', 0.609375, -0.15625, 0.109375, 0.296875, 'Weapon_Dealer', room4)
    Base.Link (room3, 'my_link_id', -0.978125, -0.169271, 1.030859, 0.333333, 'Bar', room5)
    Base.Link (room3, 'my_link_id', 0.0644531, -0.0807292, 0.0390625, 0.200521, 'Landing_Pad', room0)
    ...
    Base.Link (room6, 'my_link_id', -1, -0.997396, 1.99805, 0.0520833, 'Industrial_Planet_Surface', room1)
    Base.Link (room6, 'my_link_id', 0.927734, -0.916667, 0.0703125, 1.91406, 'Industrial_Planet_Hills', room7)
    Base.Link (room2, 'my_link_id', 0.927734, -0.916667, 0.0703125, 1.91406, 'Industrial_Planet_Hills', room7)
