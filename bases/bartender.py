...
tender={"general":("Hey, pal. What'll it be?",
                   ...
                   "I think the Luddites are crazy, just like anyone else. But I have to admit, their anti-technology lobbyists in the Congress have gotten them to pass a law BANNING robots and droids from serving alcohol. And that friend, is good news for me!"
                   "Can I get you anything? Whiskey? Vodka? Aarnbach's Acid? I'm all for being social, but I do have a business to run.",
        ...
        "The Confederation authorities busted a local discussion group last month, and the fallout has been scathing.  Who thought that anyone would actually enforce that silly law they passed banning the Interstellar Socialist Organization?  I mean, they're radical and all...  but it was a discussion group!",
        "There was a pro-ISO rally in the central square of the local campus yesterday.  They started calling for all sorts of government and economic reforms, but eventually turned to advocating bloody revolution instead.",
        ...
        "advice":("If youre looking for a mission, talk to the guys who sometimes sit at the front tables there. Or you can check the mission terminal.",
        	...
        	"The first thing you want to have if you get in a scrap is a good shield generator. That helps if you decide to run OR fight.",
        	...
        	"The jump drive is the key to the galaxy. Without one, you can't access the network of wormholes we use for interstellar travel.",
        	"The best tool for interplanetary trade is common sense. What does an agricultural colony have that a space station probably needs? That's right, food.",
        	...
        	"Watch your energy bar as you fire your guns. If you're running out of energy too quickly, considering buying a more powerful engine to produce more power.",
        ...
        "tale":("Got any stories to tell? Last week I had a patron who just could not stop talking about his battles with pirates.",
                    ...
                    "Some privateer was in here a while back, bragging about his adventures in unknown space. He kept talking about these wonderful alien artifacts that he used to improve his ship.",
                    ...
                    "I think that the craziest story I've ever heard in this bar...  is where this pilot says he was out on the frontier, flying alone in an uncolonized system. He's running pretty much with zero emissions, so no Aera raiders can spot him. He's thirty thousand clicks out from the jump point, when his passive sensors go CRAZY. He says thats when a sparkling, glowing green orb popped out of the jump point, and just took off to another jump point at insane speeds. The pilot sold his ship right after he left my bar."
                    "...and so there I was. Militia patrol to my port, Confed fighter wing to my starboard... and my dumped cargo coasting slowly away from me. I thought I was home free. Suddenly, they all started powering up their weapons. 'I'm fracked', I thought. Turns out there was a wing of Aeran Derivates on an attack vector. Then I thought 'Now I'm REALLY fracked'.",
                    "There was a guy in here the other day who claimed he was the sole survivor of some colony massacre by the Aera out on the frontier. That's the problem with all these independent colonies Confed doesn't know about... they can't get any protection from the Navy.",
                    "My brother signed up for the New Farmers of the Confederation program, and got shipped out to a new agricultural colony out on the frontier. I got a trans from him last week, and he said that life was really hard compared to Mars, but that he was happy to be living on an M class planet finally.",
                    ...
                    "There's got to be someone behind the Luddites. I mean, fanatic anti-technologists don't have the money or the resources to buy ships, train pilots, or construct highly organized terrorist operations.  Now who would stand to gain from the Luddite craziness?  Hmmm....",),
        ...
        "I've got a sister in the Navy. She's a weapons officer in the 6th Fleet out on the Aera border. I asked her to fry a few aliens for me!",
        "I've got a buddy in the Confed Marines, attached to the 10th Fleet. He's out on the open frontier, the complete opposite side of the Confederation from the fighting. He complains about it being boring out there... but if I was him I'd be pretty happy.",
        "There's a rumor going around that the Aera have some big capital ships deep inside their home territory. I don't mean just big... I mean BIG big. Big enough to eat one of the old Starrunners for breakfast. Then again, it's just a rumor.",
        "I've heard that the Aera don't have any concept of 'prisoners of war'. I hear that the Navy started to give cyanide pills to pilots in case the wrong side picks them up after they bail out.",
        "The Aera might seem to be more powerful than us at first glance... but how much of their economy is dedicated to war? Most of it, I'd say. The Confederation spends only a few percent of its gross product on the military. If push comes to shove... we'll knock 'em over for sure!",
        ...
        "You know what they say... 'War is good for business'?  Well it ain't true. How many pilots that were regulars here have been drafted?  How many privateers have gotten fried on escort duty?  A lot.  That's a lot of people NOT buying drinks from me.  Lousy war.",
	...
	"mining":("You want to know what the big story around here is? Industrial gems. They're just about the most valuable raw material known to man, and we just stumbled onto a rich vein of them. That ought to keep this base, and this bar, in the black for decades to come!",
		                      "Confed has been treating us miners pretty good lately. In terms of giving us adequate defense coverage, I mean. They're still trying to give us the shaft when it comes to mandatory ore contracts. I mean, there's a war on and all... but the boys who come in here need to be able to pay for their drinks!",
		                      ...
		                      "We had a bomb go off in a newly arrived shipment of boring droids last month. Nobody got killed, but a few good miners had to get replacement limbs. We got a message from the Luddites claiming responsibility. Those psychos are completely insane.",
	...
	"agricultural":("Have you heard the news?  The Lars family brought a melon to market yesterday that was four feet 'round!",
	                        ...
	                        "People around here don't like to talk about it, but we're all afraid that we'd be an easy target for an Aera attack. We don't have any orbital defenses, no fighter wing... heck, we don't even have a ground battery. All it would take is one Aera bomber with a fusion warhead to take out half the colony!",
	                        ...
	                        "I visited one of those industrial worlds a few years ago... So many people, and you couldn't even see the stars at night!",
	                        ...
	                        "A lot of those crazy anti-tech Luddites come from agricultural worlds that were founded years ago as isolated subsistence colonies, and have only recently had their economy retooled for mass export. Some people just can't take the shock of all the heavy machinery and laborer robots that take over practically overnight.",
	...
	"caribbean":("The buzz is that they're going to be shooting Dominique Moore's new holoVid on this planet soon! 'Greased Love Lightning' is the working title.",
	                     ...
	                     "I actually don't plan on being a bartender for the rest of my life... My boyfriend right now is trying to get me into the modeling agency he works for! I can see it now... my face and body splashed across holoscreens and starscrapers across the Confederation!",
	                     ...
	                     "You should see some of the cubes who come through here on vacation. They come from a bland suburb on some standard M-class planet, stay here a week, and go back vibrant and full of life! I've heard that those people are thirty-seven times more likely to snap and massacre their coworkers within six months of their return, though. I wonder what that means.",
